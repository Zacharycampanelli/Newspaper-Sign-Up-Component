  ...
  return (
    <Dialog open={true} fullScreen/*onClose={onClose}*/>
     ...
     <Success  />
        ...
        <Button
              variant="contained"
              sx={{ backgroundColor: 'darkSlateGrey', width: '82%', borderRadius: '8px', mt: '1.5rem', position: 'absolute', bottom: '2rem', ':hover': { background: 'linear-gradient(225deg, #FF6A3A, #FF527B)'}}}
              onClick={onClose}
            >
